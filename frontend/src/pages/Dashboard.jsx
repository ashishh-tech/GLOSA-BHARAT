    ...
    return (
        <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] flex font-inter transition-colors duration-500 overflow-hidden">
            ...
            {isLoggedIn && (
                <>
                    {/* Mobile Top Nav */}
                    <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white dark:bg-[#0f172a] border-b border-slate-200 dark:border-slate-800 z-[900] flex items-center justify-between px-4 transition-colors duration-300">
                        <div className="flex items-center gap-2">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/5/55/Emblem_of_India.svg" alt="GOI" className="h-6 dark:invert shrink-0" />
                            <h1 className="text-navy dark:text-blue-400 text-sm font-black tracking-tight">GLOSA BHARAT</h1>
                        </div>
                        <button
                    ...
                    <AnimatePresence>
                        {sidebarOpen && (
                            <motion.div
                                ...
                                className="fixed inset-0 bg-navy/40 backdrop-blur-sm z-[950] lg:hidden"
                            />
                        )}
                    </AnimatePresence>

                    <main className="flex-1 lg:p-8 p-4 pt-20 lg:pt-8 h-screen overflow-y-auto scrollbar-hide min-w-0">
                    ...
                    <Link
                        to="/rider"
                        className="fixed bottom-6 right-6 z-[800] flex items-center gap-2.5 px-4 py-3 rounded-2xl shadow-2xl font-black text-sm text-white transition-all hover:scale-105 active:scale-95 border border-white/10"
                        style={{
